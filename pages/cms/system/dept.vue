...
import type { IDeptModel, IDeptModelQuery } from '~/composables/api/base/index.type'
...
const templateData = genCmsTemplateData2<TemplateType, IDeptModelQuery, null>({
...
<template>
  <el-container class="CmsUser">
    <TemplateStandardCms :rules="rules" :list="list" :template-data="templateData" name="部门">
      <template #QueryForm>
